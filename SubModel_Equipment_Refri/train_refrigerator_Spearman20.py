...
# Selected Feature
corr_spaer_Rc01_01 = x_data.corrwith(Train['Rc01_LOWT_Parameter'], method='spearman')  # Spearman Correlation
corr_spaer_Rc01_01 = abs(corr_spaer_Rc01_01)
indices_01 = np.argsort(corr_spaer_Rc01_01)[::-1]
...
for f in range(x_data.shape[1]):
   print("%2d) %-*s %f" % (f + 1, 30, 
                            feature_names[indices_01[f]], corr_spaer_Rc01_01[indices_01[f]]))

   Feature_01.append(feature_names[indices_01[f]])
   Correlation_feature_01.append(corr_spaer_Rc01_01[indices_01[f]])
...
for i in range(kfold):
   ...
   mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R01_para01.h5', 
   ...
   best_model_y01.save('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R01_para01.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R01_para01.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
R01_para01_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R01_para01.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Spearman_Case02_R01_para01.png')
...
# Selected Feature
corr_spaer_Rc01_02 = x_data.corrwith(Train['Rc01_COP_Parameter'], method='spearman')
corr_spaer_Rc01_02 = abs(corr_spaer_Rc01_02)
indices_02 = np.argsort(corr_spaer_Rc01_02)[::-1]
...
for f in range(x_data.shape[1]):
    print("%2d) %-*s %f" % (f + 1, 30, 
                            feature_names[indices_02[f]], corr_spaer_Rc01_02[indices_02[f]]))

    Feature_02.append(feature_names[indices_02[f]])
    Correlation_feature_02.append(corr_spaer_Rc01_02[indices_02[f]])
...
for i in range(kfold):
   ...
   es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
   mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R01_para02.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)
   ...
   best_model_y02.save('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R01_para02.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R01_para02.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
R01_para02_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R01_para02.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Spearman_Case02_R01_para02.png')
...
# Selected Feature
corr_spaer_Rc02_01 = x_data.corrwith(Train['Rc02_LOWT_Parameter'], method='spearman')
corr_spaer_Rc02_01 = abs(corr_spaer_Rc02_01)
indices_03 = np.argsort(corr_spaer_Rc02_01)[::-1]
...
for f in range(x_data.shape[1]):
    print("%2d) %-*s %f" % (f + 1, 30, 
                            feature_names[indices_03[f]], corr_spaer_Rc02_01[indices_03[f]]))

    Feature_03.append(feature_names[indices_03[f]])
    Correlation_feature_03.append(corr_spaer_Rc02_01[indices_03[f]])
...
for i in range(kfold):
   ...
   es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
   mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R02_para01.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)
   ...
   best_model_y03.save('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R02_para01.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R02_para01.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
R02_para01_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R02_para01.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Spearman_Case02_R02_para01.png')
...
# Selected Feature
corr_spaer_Rc02_02 = x_data.corrwith(Train['Rc02_COP_Parameter'], method='spearman')
corr_spaer_Rc02_02 = abs(corr_spaer_Rc02_02)
indices_04 = np.argsort(corr_spaer_Rc02_02)[::-1]
...
for f in range(x_data.shape[1]):
    print("%2d) %-*s %f" % (f + 1, 30, 
                            feature_names[indices_04[f]], corr_spaer_Rc02_02[indices_04[f]]))

    Feature_04.append(feature_names[indices_04[f]])
    Correlation_feature_04.append(corr_spaer_Rc02_02[indices_04[f]])
...
for i in range(kfold):
   ...
   es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
   mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R02_para02.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)
   ...
   best_model_y04.save('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R02_para02.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R02_para02.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
R02_para02_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Spearman20_R02_para02.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Spearman_Case02_R02_para02.png')
...
with open('Result_Estimation.csv', 'a', newline="") as f:
    writer = csv.writer(f)
    writer.writerow(['Spearman_Case02_Rc01_LOWT_Parameter', loss_y01, acc_y01, Result_R2_y01, Result_RMSE_y01, Result_MAE_y01, Result_MBE_y01])
    writer.writerow(['Spearman_Case02_Rc01_COP_Parameter', loss_y02, acc_y02, Result_R2_y02, Result_RMSE_y02, Result_MAE_y02, Result_MBE_y02])
    writer.writerow(['Spearman_Case02_Rc02_LOWT_Parameter', loss_y03, acc_y03, Result_R2_y03, Result_RMSE_y03, Result_MAE_y03, Result_MBE_y03])
    writer.writerow(['Spearman_Case02_Rc02_COP_Parameter', loss_y04, acc_y04, Result_R2_y04, Result_RMSE_y04, Result_MAE_y04, Result_MBE_y04])
...
with open('ResultPerfor_Estimation.csv', 'a', newline="") as f:
    writer = csv.writer(f)
    writer.writerow(['Spearman_Case02_R01_Power', ResultPerfor_R2_y01, ResultPerfor_RMSE_y01, ResultPerfor_MAE_y01, ResultPerfor_MBE_y01])
    writer.writerow(['Spearman_Case02_R02_Power', ResultPerfor_R2_y02, ResultPerfor_RMSE_y02, ResultPerfor_MAE_y02, ResultPerfor_MBE_y02])
    writer.writerow(['Spearman_Case02_R01_COP', ResultPerfor_R2_y03, ResultPerfor_RMSE_y03, ResultPerfor_MAE_y03, ResultPerfor_MBE_y03])
    writer.writerow(['Spearman_Case02_R02_COP', ResultPerfor_R2_y04, ResultPerfor_RMSE_y04, ResultPerfor_MAE_y04, ResultPerfor_MBE_y04])
