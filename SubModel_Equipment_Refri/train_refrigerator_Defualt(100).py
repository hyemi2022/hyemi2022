...
submission = pd.read_csv('c:\\System_Air\\Input\\Test\\TRNSYS2017_789.csv')
...
for i in range(kfold):
   ...
   mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_R01_para01.h5', 
   ...
   best_model_y01.save('C:\\System_Air\\best_model\\physics_parameter\\Default_R01_para01.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_R01_para01.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
R01_para01_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Default_R01_para01.h5')
history01 = R01_para01_Model.fit(x_data, Rc01_ytrain_LOWT, epochs=1000, batch_size=12240, validation_split=0.2, verbose=1, callbacks=[es, mc])
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Case10_R01_para01.png')


R01_Para01_Pred = R01_para01_Model.predict(x_predict)
...
for i in range(kfold):
   ...
   es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
   mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_R01_para02.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)
   ...
   best_model_y02.save('C:\\System_Air\\best_model\\physics_parameter\\Default_R01_para02.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_R01_para02.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
R01_para02_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Default_R01_para02.h5')
history02 = R01_para02_Model.fit(x_data, Rc01_ytrain_COP, epochs=1000, batch_size=12240, validation_split=0.2, verbose=1, callbacks=[es, mc])
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Case10_R01_para02.png')


R01_para02_Pred = R01_para02_Model.predict(x_predict)
...
for i in range(kfold):
   ...
   es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
   mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_R02_para01.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)
   ...
   best_model_y03.save('C:\\System_Air\\best_model\\physics_parameter\\Default_R02_para01.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_R02_para01.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
R02_para01_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Default_R02_para01.h5')
history03 = R02_para01_Model.fit(x_data, Rc02_ytrain_LOWT, epochs=1000, batch_size=12240, validation_split=0.2, verbose=1, callbacks=[es, mc])
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Case10_R02_para01.png')


R02_Para01_Pred = R02_para01_Model.predict(x_predict)
...
for i in range(kfold):
   ...
   es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
   mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_R02_para02.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)
   ...
   best_model_y04.save('C:\\System_Air\\best_model\\physics_parameter\\Default_R02_para02.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_R02_para02.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
R02_para02_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Default_R02_para02.h5')
history04 = R02_para02_Model.fit(x_data, Rc02_ytrain_COP, epochs=1000, batch_size=12240, validation_split=0.2, verbose=1, callbacks=[es, mc])
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Case10_R02_para02.png')


R02_para02_Pred = R02_para02_Model.predict(x_predict)
...
# Evaluate
loss_y01, acc_y01 = R01_para01_Model.evaluate(x_predict, R01_Para01_Pred, batch_size=128)
loss_y02, acc_y02 = R01_para02_Model.evaluate(x_predict, R01_para02_Pred, batch_size=128)
loss_y03, acc_y03 = R02_para01_Model.evaluate(x_predict, R02_Para01_Pred, batch_size=128)
loss_y04, acc_y04 = R02_para02_Model.evaluate(x_predict, R02_para02_Pred, batch_size=128)
...
with open('Result_Estimation.csv', 'a', newline="") as f:
    writer = csv.writer(f)
    writer.writerow(['Case10_Rc01_LOWT_Parameter', loss_y01, acc_y01, Result_R2_y01, Result_RMSE_y01, Result_MAE_y01, Result_MBE_y01])
    writer.writerow(['Case10_Rc01_COP_Parameter', loss_y02, acc_y02, Result_R2_y02, Result_RMSE_y02, Result_MAE_y02, Result_MBE_y02])
    writer.writerow(['Case10_Rc02_LOWT_Parameter', loss_y03, acc_y03, Result_R2_y03, Result_RMSE_y03, Result_MAE_y03, Result_MBE_y03])
    writer.writerow(['Case10_Rc02_COP_Parameter', loss_y04, acc_y04, Result_R2_y04, Result_RMSE_y04, Result_MAE_y04, Result_MBE_y04])
...
with open('ResultPerfor_Estimation.csv', 'a', newline="") as f:
    writer = csv.writer(f)
    writer.writerow(['Case10_R01_Power', ResultPerfor_R2_y01, ResultPerfor_RMSE_y01, ResultPerfor_MAE_y01, ResultPerfor_MBE_y01])
    writer.writerow(['Case10_R02_Power', ResultPerfor_R2_y02, ResultPerfor_RMSE_y02, ResultPerfor_MAE_y02, ResultPerfor_MBE_y02])
    writer.writerow(['Case10_R01_COP', ResultPerfor_R2_y03, ResultPerfor_RMSE_y03, ResultPerfor_MAE_y03, ResultPerfor_MBE_y03])
    writer.writerow(['Case10_R02_COP', ResultPerfor_R2_y04, ResultPerfor_RMSE_y04, ResultPerfor_MAE_y04, ResultPerfor_MBE_y04])
