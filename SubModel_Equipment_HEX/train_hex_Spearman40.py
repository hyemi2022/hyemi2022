...
for i in range(kfold):
    ...
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Spearman40_HEX_KA.h5', 
    ...
    best_model_y01.save('C:\\System_Air\\best_model\\physics_parameter\\Spearman40_HEX_KA.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Spearman40_HEX_KA.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
MLP_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Spearman40_HEX_KA.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Spearman_Case04.png')
...
with open('Result_Estimation.csv', 'a', newline="") as f:
    writer = csv.writer(f)
    writer.writerow(['Spearman_Case04', loss, acc, Result_KA_R2, Result_KA_RMSE, Result_KA_MAE, Result_KA_MBE])
...
with open('ResultTempHEX_Estimation.csv', 'a', newline="") as f:
    writer = csv.writer(f)
    writer.writerow(['SOWT_Spearman_Case04', Result_SOWT_R2, Result_SOWT_RMSE, Result_SOWT_MAE, Result_SOWT_MBE])
    writer.writerow(['LOWT_Spearman_Case04', Result_LOWT_R2, Result_LOWT_RMSE, Result_LOWT_MAE, Result_LOWT_MBE])
...
submission.to_csv('Spearman40_Correlation.csv', index = False)
