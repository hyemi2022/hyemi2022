...
# Selected Feature
corr_pears_flow01 = x_data.corrwith(Train['R01Pump_Flow'], method='pearson')  # Pearson Correlation
corr_pears_flow01 = abs(corr_pears_flow01)
indices_01 = np.argsort(corr_pears_flow01)[::-1]

Feature_01 = []
Correlation_feature_01 = []
for f in range(x_data.shape[1]):
    print("%2d) %-*s %f" % (f + 1, 30, 
                            feature_names[indices_01[f]], corr_pears_flow01[indices_01[f]]))

    Feature_01.append(feature_names[indices_01[f]])
    Correlation_feature_01.append(corr_pears_flow01[indices_01[f]])
...
for i in range(kfold):
    ...
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y01.h5', 
    ...
    best_model_Flow_y01.save('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y01.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y01.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
Flow_y01_Model = load_model('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y01.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Pearson_Case02_y01.png')
...
# Selected Feature
corr_pears_flow02 = x_data.corrwith(Train['R02Pump_Flow'], method='pearson')
corr_pears_flow02 = abs(corr_pears_flow02)
indices_02 = np.argsort(corr_pears_flow02)[::-1]

Feature_02 = []
Correlation_feature_02 = []
for f in range(x_data.shape[1]):
    print("%2d) %-*s %f" % (f + 1, 30, 
                            feature_names[indices_02[f]], corr_pears_flow02[indices_02[f]]))

    Feature_02.append(feature_names[indices_02[f]])
    Correlation_feature_02.append(corr_pears_flow02[indices_02[f]])
...
for i in range(kfold):
    ...
    es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y02.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)
    ...
    best_model_Flow_y02.save('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y02.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y02.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
Flow_y02_Model = load_model('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y02.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Pearson_Case02_y02.png')
...
# Selected Feature
corr_pears_flow03 = x_data.corrwith(Train['ST01Pump_Flow'], method='pearson')
corr_pears_flow03 = abs(corr_pears_flow03)
indices_03 = np.argsort(corr_pears_flow03)[::-1]

Feature_03 = []
Correlation_feature_03 = []
for f in range(x_data.shape[1]):
    print("%2d) %-*s %f" % (f + 1, 30, 
                            feature_names[indices_03[f]], corr_pears_flow03[indices_03[f]]))

    Feature_03.append(feature_names[indices_03[f]])
    Correlation_feature_03.append(corr_pears_flow03[indices_03[f]])
...
for i in range(kfold):
    ...
    es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y03.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)
    ...
    best_model_Flow_y03.save('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y03.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y03.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
Flow_y03_Model = load_model('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y03.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Pearson_Case02_y03.png')
...
# Selected Feature
corr_pears_flow04 = x_data.corrwith(Train['HEX01Pump_Flow'], method='pearson')
corr_pears_flow04 = abs(corr_pears_flow04)
indices_04 = np.argsort(corr_pears_flow04)[::-1]

Feature_04 = []
Correlation_feature_04 = []
for f in range(x_data.shape[1]):
    print("%2d) %-*s %f" % (f + 1, 30, 
                            feature_names[indices_04[f]], corr_pears_flow04[indices_04[f]]))

    Feature_04.append(feature_names[indices_04[f]])
    Correlation_feature_04.append(corr_pears_flow04[indices_04[f]])
...
for i in range(kfold):
    ...
    es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y04.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)
    ...
    best_model_Flow_y04.save('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y04.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y04.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
Flow_y04_Model = load_model('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y04.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Pearson_Case02_y04.png')
...
# Selected Feature
corr_pears_flow05 = x_data.corrwith(Train['2ndPump_Flow'], method='pearson')
corr_pears_flow05 = abs(corr_pears_flow05)
indices_05 = np.argsort(corr_pears_flow05)[::-1]

Feature_05 = []
Correlation_feature_05 = []
for f in range(x_data.shape[1]):
    print("%2d) %-*s %f" % (f + 1, 30, 
                            feature_names[indices_05[f]], corr_pears_flow05[indices_05[f]]))

    Feature_05.append(feature_names[indices_05[f]])
    Correlation_feature_05.append(corr_pears_flow05[indices_05[f]])
...
for i in range(kfold):
    ...
    es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y05.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)
    ...
    best_model_Flow_y05.save('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y05.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y05.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
Flow_y05_Model = load_model('C:\\System_Air\\best_model\\IVS_Case\\Pearson20_flow_y05.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Pearson_Case02_y05.png')
...
with open('Result_Estimation.csv', 'a', newline="") as f:
    writer = csv.writer(f)
    writer.writerow(['Pearson_Case02_y01', loss_y01, acc_y01, Result_R2_y01, Result_RMSE_y01, Result_MAE_y01, Result_MBE_y01])
    writer.writerow(['Pearson_Case02_y02', loss_y02, acc_y02, Result_R2_y02, Result_RMSE_y02, Result_MAE_y02, Result_MBE_y02])
    writer.writerow(['Pearson_Case02_y03', loss_y03, acc_y03, Result_R2_y03, Result_RMSE_y03, Result_MAE_y03, Result_MBE_y03])
    writer.writerow(['Pearson_Case02_y04', loss_y04, acc_y04, Result_R2_y04, Result_RMSE_y04, Result_MAE_y04, Result_MBE_y04])
    writer.writerow(['Pearson_Case02_y05', loss_y05, acc_y05, Result_R2_y05, Result_RMSE_y05, Result_MAE_y05, Result_MBE_y05])
