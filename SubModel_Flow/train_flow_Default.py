...
for i in range(kfold):
    ...
    def keras_model_01():
        ...
        model.add(Dense(200, input_dim = 14, kernel_initializer = 'random_uniform', activation = 'relu'))
    ...
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Flow_y01_100.h5', 
    ...
    best_model_Flow_y01.save('C:\\System_Air\\best_model\\IVS_Case\\Flow_y01_100.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Flow_y01_100.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
Flow_y01_Model = load_model('C:\\System_Air\\best_model\\IVS_Case\\Flow_y01_100.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Pearson_Case10_y01.png')
...
for i in range(kfold):
    ...
    es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Flow_y02_100.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)
    ...
    best_model_Flow_y02.save('C:\\System_Air\\best_model\\IVS_Case\\Flow_y02_100.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Flow_y02_100.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
Flow_y02_Model = load_model('C:\\System_Air\\best_model\\IVS_Case\\Flow_y02_100.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Pearson_Case10_y02.png')
...
for i in range(kfold):
    ...
    es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Flow_y03_100.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)
    ...
    best_model_Flow_y03.save('C:\\System_Air\\best_model\\IVS_Case\\Flow_y03_100.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Flow_y03_100.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
Flow_y03_Model = load_model('C:\\System_Air\\best_model\\IVS_Case\\Flow_y03_100.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Pearson_Case10_y03.png')
...
for i in range(kfold):
    ...
    es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Flow_y04_100.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)
    ...
    best_model_Flow_y04.save('C:\\System_Air\\best_model\\IVS_Case\\Flow_y04_100.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Flow_y04_100.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
Flow_y04_Model = load_model('C:\\System_Air\\best_model\\IVS_Case\\Flow_y04_100.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Pearson_Case10_y04.png')
...
for i in range(kfold):
    ...
    es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Flow_y05_100.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)
    ...
    best_model_Flow_y05.save('C:\\System_Air\\best_model\\IVS_Case\\Flow_y05_100.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\IVS_Case\\Flow_y05_100.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
Flow_y05_Model = load_model('C:\\System_Air\\best_model\\IVS_Case\\Flow_y05_100.h5')
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Pearson_Case10_y05.png')
...
submission.to_csv('Flowrate_Input_100.csv', index = False)
...
with open('Result_Estimation.csv', 'a', newline="") as f:
    writer = csv.writer(f)
    writer.writerow(['Pearson_Case10_y01', loss_y01, acc_y01, Result_R2_y01, Result_RMSE_y01, Result_MAE_y01, Result_MBE_y01])
    writer.writerow(['Pearson_Case10_y02', loss_y02, acc_y02, Result_R2_y02, Result_RMSE_y02, Result_MAE_y02, Result_MBE_y02])
    writer.writerow(['Pearson_Case10_y03', loss_y03, acc_y03, Result_R2_y03, Result_RMSE_y03, Result_MAE_y03, Result_MBE_y03])
    writer.writerow(['Pearson_Case10_y04', loss_y04, acc_y04, Result_R2_y04, Result_RMSE_y04, Result_MAE_y04, Result_MBE_y04])
    writer.writerow(['Pearson_Case10_y05', loss_y05, acc_y05, Result_R2_y05, Result_RMSE_y05, Result_MAE_y05, Result_MBE_y05])
