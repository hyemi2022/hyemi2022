...
x_data = Train[feature_names] # Total 19
...
for i in range(kfold):
    ...
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\d_p01_parameter.h5', 
    ...
    best_model_y01.save('C:\\System_Air\\best_model\\physics_parameter\\Default_p01_parameter.h5')
...
#### best Fitting Model ####
es=EarlyStopping(monitor='val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_p01_parameter.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
y01_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Default_p01_parameter.h5')
history01 = y01_Model.fit(x_data, p01_Para, epochs=1000, batch_size=12240, validation_split=0.2, verbose=1, callbacks=[es, mc])
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Case10_y01.png')


P01_ParaPred = y01_Model.predict(x_predict)
...
for i in range(kfold):
    ...
    es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_p02_parameter.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)

    best_model_y02 = keras_model_02()
    best_model_y02.fit(partial_train_data_02, partial_train_targets_02, epochs=30, batch_size=9000)
    best_model_y02.save('C:\\System_Air\\best_model\\physics_parameter\\Default_p02_parameter.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_p02_parameter.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
y02_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Default_p02_parameter.h5')
history02 = y02_Model.fit(x_data, p02_Para, epochs=1000, batch_size=12240, validation_split=0.2, verbose=1, callbacks=[es, mc])
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Case10_y02.png')


P02_ParaPred = y02_Model.predict(x_predict)
...
for i in range(kfold):
    ...
    es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_p03_parameter.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)

    best_model_y03 = keras_model_03()
    best_model_y03.fit(partial_train_data_03, partial_train_targets_03, epochs=30, batch_size=9000)
    best_model_y03.save('C:\\System_Air\\best_model\\physics_parameter\\Default_p03_parameter.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_p03_parameter.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
y03_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Default_p03_parameter.h5')
history03 = y03_Model.fit(x_data, p03_Para, epochs=1000, batch_size=12240, validation_split=0.2, verbose=1, callbacks=[es, mc])
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Case10_y03.png')


P03_ParaPred = y03_Model.predict(x_predict)
...
for i in range(kfold):
    ...
    es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_p04_parameter.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)

    best_model_y04 = keras_model_04()
    best_model_y04.fit(partial_train_data_04, partial_train_targets_04, epochs=30, batch_size=9000)
    best_model_y04.save('C:\\System_Air\\best_model\\physics_parameter\\Default_p04_parameter.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_p04_parameter.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
y04_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Default_p04_parameter.h5')
history04 = y04_Model.fit(x_data, p04_Para, epochs=1000, batch_size=12240, validation_split=0.2, verbose=1, callbacks=[es, mc])
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Case10_y04.png')


P04_ParaPred = y04_Model.predict(x_predict)
...
for i in range(kfold):
    ...
    es = EarlyStopping(monitor = 'val_loss', patience=30, mode= 'min', min_delta=0.001, verbose=1)
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_p05_parameter.h5', 
                            monitor='val_loss', mode='min', verbose=1, save_best_only=True)

    best_model_y05 = keras_model_05()
    best_model_y05.fit(partial_train_data_05, partial_train_targets_05, epochs=30, batch_size=9000)
    best_model_y05.save('C:\\System_Air\\best_model\\physics_parameter\\Default_p05_parameter.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_p05_parameter.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
y05_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Default_p05_parameter.h5')
history05 = y05_Model.fit(x_data, p05_Para, epochs=1000, batch_size=12240, validation_split=0.2, verbose=1, callbacks=[es, mc])
...
plt.legend(bbox_to_anchor=(0.5, 1.1), loc='upper center', ncol=2, fontsize=10)
plt.tight_layout()
plt.savefig('Case10_y05.png')


P05_ParaPred = y05_Model.predict(x_predict)
...
submission.to_csv('Default_ALLInput.csv', index = False)
...
# Evaluate
loss_y01, acc_y01 = y01_Model.evaluate(x_predict, P01_ParaPred, batch_size=128)
loss_y02, acc_y02 = y02_Model.evaluate(x_predict, P02_ParaPred, batch_size=128)
loss_y03, acc_y03 = y03_Model.evaluate(x_predict, P03_ParaPred, batch_size=128)
loss_y04, acc_y04 = y04_Model.evaluate(x_predict, P04_ParaPred, batch_size=128)
loss_y05, acc_y05 = y05_Model.evaluate(x_predict, P05_ParaPred, batch_size=128)
...
with open('Result_Estimation.csv', 'a', newline="") as f:
    writer = csv.writer(f)
    writer.writerow(['Case10_P01', loss_y01, acc_y01, Result_R2_y01, Result_RMSE_y01, Result_MAE_y01, Result_MBE_y01])
    writer.writerow(['Case10_P02', loss_y02, acc_y02, Result_R2_y02, Result_RMSE_y02, Result_MAE_y02, Result_MBE_y02])
    writer.writerow(['Case10_P03', loss_y03, acc_y03, Result_R2_y03, Result_RMSE_y03, Result_MAE_y03, Result_MBE_y03])
    writer.writerow(['Case10_P04', loss_y04, acc_y04, Result_R2_y04, Result_RMSE_y04, Result_MAE_y04, Result_MBE_y04])
    writer.writerow(['Case10_P05', loss_y05, acc_y05, Result_R2_y05, Result_RMSE_y05, Result_MAE_y05, Result_MBE_y05])
...
with open('ResultPower_Estimation.csv', 'a', newline="") as f:
    writer = csv.writer(f)
    writer.writerow(['Power_Case10_P01', ResultPower_R2_y01, ResultPower_RMSE_y01, ResultPower_MAE_y01, ResultPower_MBE_y01])
    writer.writerow(['Power_Case10_P02', ResultPower_R2_y02, ResultPower_RMSE_y02, ResultPower_MAE_y02, ResultPower_MBE_y02])
    writer.writerow(['Power_Case10_P03', ResultPower_R2_y03, ResultPower_RMSE_y03, ResultPower_MAE_y03, ResultPower_MBE_y03])
    writer.writerow(['Power_Case10_P04', ResultPower_R2_y04, ResultPower_RMSE_y04, ResultPower_MAE_y04, ResultPower_MBE_y04])
    writer.writerow(['Power_Case10_P05', ResultPower_R2_y05, ResultPower_RMSE_y05, ResultPower_MAE_y05, ResultPower_MBE_y05])
