...
# y_train data --> Tank Parameters Heat Loss
...
for i in range(kfold):
    ...
    mc = ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_Tank_parameter.h5', 
    ...
    best_model_y01.save('C:\\System_Air\\best_model\\physics_parameter\\Default_Tank_parameter.h5')
...
mc=ModelCheckpoint('C:\\System_Air\\best_model\\physics_parameter\\Default_Tank_parameter.h5', 
                        monitor='val_loss', mode='min', verbose=1, save_best_only = True)
y01_Model = load_model('C:\\System_Air\\best_model\\physics_parameter\\Default_Tank_parameter.h5')
...
with open('Result_Estimation.csv', 'a', newline="") as f:
    writer = csv.writer(f)
    writer.writerow(['Case10_Tank_US', loss, acc, Result_Para_R2, Result_Para_RMSE, Result_Para_MAE, Result_Para_MBE])
...
with open('ResultTempTank_Estimation.csv', 'a', newline="") as f:
    writer = csv.writer(f)
    writer.writerow(['Case10_Layer01', Result_Layer01_R2, Result_Layer01_RMSE, Result_Layer01_MAE, Result_Layer01_MBE])
    writer.writerow(['Case10_Layer10', Result_Layer10_R2, Result_Layer10_RMSE, Result_Layer10_MAE, Result_Layer10_MBE])
